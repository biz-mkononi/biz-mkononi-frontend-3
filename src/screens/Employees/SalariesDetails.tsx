        ...
        <>
            {
                isLoading ? <div className="text-center"><CircularProgress color="success" /></div> :
                    <div className="container p-3">
                        ...
                        {
                            open ? <AlertDialog open={open} handleClose={handleClose} title="this salary" handleDelete={handleDelete} /> : ""
                        }
                        ...
                        <div className="row padding mb-4">
                            <div className="col-lg-6">
                                <div className='details-button' style={{ display: "flex" }}>
                                    ...
                                    <button className='btn btn-warning btn-md' onClick={(() => navigate(`/employees/salaries/${params.id}/update-details`))}> Update</button>
