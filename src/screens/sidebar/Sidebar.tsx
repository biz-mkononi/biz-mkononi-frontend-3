            ...
            <aside className="w-64" aria-label="Sidebar">
                <div className="overflow-y-auto sidebar  px-3 bg-gray-50 rounded dark:bg-gray-800">
                    ...
                    <ul className="space-y-2 p-3">
                        <li>
                            <a href="#" className="flex items-center p-3 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                <i className="fa-solid fa-chart-area"></i>
                                <span className="ml-3">Insights</span>
                            </a>
                        </li>
                        <li>
                            <button type="button" className="flex items-center p-3 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                                <i className="fa-solid fa-business-time"></i>
                                <span className="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Businesses</span>
