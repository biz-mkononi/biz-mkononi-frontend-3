...
import { getSingleSupplier, updateSingleSupplier } from '../../Data/Suppliers/Data';
                        ...
                        <div className="row padding">
                            <div className="col-lg-6">
                                <div className='details-button' style={{ display: "flex" }}>
                                    ...
                                    <button className='btn btn-primary btn-md' onClick={(() => navigate(`/suppliers/${params.id}/details`))}>Manage</button>
                                </div>
                            </div>
                            ...
                            <form onSubmit={onSubmit}>
                                <div className="row padding mt-3">
                                    <div className="col-lg-4">
                                        <label htmlFor="basic-url" className="form-label ">Supplier Name</label>
                                    ...
                                    <div className="col-lg-4">
                                        <label htmlFor="basic-url" className="form-label">Supplier Email</label>
                                        <div className="input-group mb-5">
                                ...
                                <div className="text-center mt-3">
                                    {
                                        isUpdating ? <button className="btn btn-success btn-md" disabled>Updating</button> :
                                            <button className="btn btn-success btn-md">Update Supplier</button>
                                    }
