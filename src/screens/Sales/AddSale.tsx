...
const AddSale = ({ id }: any) => {
    const [forms, setForms] = useState<Form[]>([{ product: '', salePrice: 0, quantity: 0, productId: '' }]);
    ...
    const handleAddForm = () => {
        setForms([...forms, { product: '', salePrice: 0, quantity: 0, productId: '' }]);
    };
            ...
            <Card className='p-3'>
                ...
                <form onSubmit={onSubmit}>
                                    ...
                                    <div className="row padding">
                                        ...
                                        <div className="col-lg-6">
                                            ...
                                            <div className="input-group mb-5">
                                                ...
                                                <input type="text" value={form.salePrice} name="locationDetails" className="form-control" placeholder="details" aria-label="Username" aria-describedby="basic-addon1" />
                                            </div>
                                        </div>

                                        <div className="col-lg-6">
                                            <h2 className='mb-4 mt-5'>Subtotal : Ksh: {form.salePrice * form.quantity}</h2>
                                        </div>
                    ...
                    <div className="text-center mt-3">
                        <button type='submit' className="btn btn-success btn-md" disabled={isLoading ? true : false} > {isLoading ? "Adding" : "Add Sale"} </button>
                    </div>
