                        ...
                        <div className="row padding">
                            <div className="col-lg-6">
                                <div className='details-button' style={{ display: "flex" }}>
                                    ...
                                    <button className='btn btn-primary btn-md' onClick={(() => navigate(`/expense/${params.id}/details`))}>Manage</button>
                                </div>
                            </div>
                        ...
                        <Card className='p-3'>
                            <form onSubmit={onSubmit}>
                                ...
                                <div className="input-group mb-5">
                                    ...
                                    <input type="text" onChange={handleChange} defaultValue={data.title} name="title" className="form-control" placeholder="name" aria-label="Username" aria-describedby="basic-addon1" />
                                </div>
                                <label htmlFor="basic-url" className="form-label ">Amount (Ksh)</label>
                                <div className="input-group mb-5">
                                    <span className="input-group-text" id="basic-addon1"><BusinessIcon /></span>
                                    <input type="text" onChange={handleChange} defaultValue={data.amount} name="amount" className="form-control" placeholder="amount" aria-label="Username" aria-describedby="basic-addon1" />
                                </div>
                                ...
                                <div className="input-group mb-3">
                                    <textarea className="form-control" onChange={handleDescriptionChange} defaultValue={data.description} name='description' aria-label="With textarea"></textarea>
                                </div>
                                ...
                                <div className="text-center mt-3">
                                    {
                                        isUpdating ? <button className="btn btn-success btn-md" disabled>Updating</button> :
                                            <button className="btn btn-success btn-md">Update Expense</button>
                                    }
